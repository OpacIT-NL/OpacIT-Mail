...
(function () {
	...
	*/
	...
	//			+ b64EncodeJSONSafe(url.replace(/ /g, '%20')),
		...
		themePreviewLink = theme => {
			if (theme.endsWith('@nextcloud')) {
				...
				return parent.OC.webroot + '/themes/' + encodeURI(theme) + '/x2mail/preview.png';
			}
	...
	const
		...
		// see /x2mail/v/0.0.0/app/localization/relativetimeformat/
	...
	const
		errorTip = (element, value) => value
				? setTimeout(() => element.setAttribute('data-x2mailErrorTip', value), 100)
				: element.removeAttribute('data-x2mailErrorTip'),
	...
	*/
	...
	const contentType = 'x2mail/emailaddress',
			...
			"uids": [
				{
					"name": "demo",
					"comment": "",
					"email": "demo@x2mail.dev",
					"uid": "demo <demo@x2mail.dev>",
					"revoked": false,
					"invalid": false
				}
			],
...
<body></body>
	...
	*/
	...
	const rlContentType = 'x2mail/action',
