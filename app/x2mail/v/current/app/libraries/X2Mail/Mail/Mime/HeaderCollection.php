 ...
 * @package Mime
 */
class HeaderCollection extends \X2Mail\Mail\Base\Collection
{
	 ...
	 * spf=pass (ORIGINATING: domain of "x2mail@domain.tld" designates 0.0.0.0 as permitted sender) smtp.mailfrom="x2mail@domain.tld";
