...
namespace X2Mail\Mail\Cache\Drivers;
 ...
 * @subpackage Drivers
 */
class File implements \X2Mail\Mail\Cache\DriverInterface
{
	...
	function __construct(string $sCacheFolder)
	{
		...
		\X2Mail\Mail\Base\Utils::mkdir($this->sCacheFolder);
	...
	{
		\X2Mail\Mail\Base\Utils::RecTimeDirRemove($this->sCacheFolder, 3600 * $iTimeToClearInHours);
		return true;
	}
