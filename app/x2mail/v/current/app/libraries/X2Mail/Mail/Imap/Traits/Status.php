...
trait Status
{
	...
	public function generateETag(\X2Mail\Mail\Imap\ImapClient $oImapClient) : void
	{
		if (!$this->hasStatus) {
	 ...
	 *        ResponseList[1] => STATUS
	 */
	public function setStatusFromResponse(\X2Mail\Mail\Imap\Response $oResponse) : bool
	{
		$bResult = false;
