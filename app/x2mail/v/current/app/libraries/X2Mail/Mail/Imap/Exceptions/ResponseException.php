...
namespace X2Mail\Mail\Imap\Exceptions;
...
class ResponseException extends \X2Mail\Mail\RuntimeException
{
	...
	public function __construct(?\X2Mail\Mail\Imap\ResponseCollection $oResponses = null, string $sMessage = '', int $iCode = 0, ?\Throwable $oPrevious = null)
	{
	...
	public function GetResponses() : ?\X2Mail\Mail\Imap\ResponseCollection
	{
		return $this->oResponses;
	}

	public function GetLastResponse() : ?\X2Mail\Mail\Imap\Response
	{
