...
*/
	...
	public static function CsvStreamToContacts(/*resource*/ $rFile, string $sDelimiter) : iterable
	{
		...
		foreach ($aHeaders as $iIndex => $sItemName) {
			$sItemName = \X2Mail\Mail\Base\Utils::Utf8Clear($sItemName);
...
/*
	...
	{
		MECARD:N:demo;ORG:X2Mail;TEL:+49012345678;URL:https\://x2mail.dev;EMAIL:info@x2mail.dev;ADR:address line;;
		VCARD
	}
*/
}
