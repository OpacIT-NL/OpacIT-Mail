...
class Email implements \JsonSerializable
{
	...
	private string $sDkimStatus = 'none'; // DkimStatus::NONE
	...
	function __construct(string $sEmail, string $sDisplayName = '')
	{
		...
		$this->sEmail = \opacit_mail\Engine\IDN::emailToAscii(Utils::Trim($sEmail));
...
//					$sQuoteChar = $sEmailAddress[$iCurrentIndex];
	...
	{
		return $bUtf8 ? \opacit_mail\Engine\IDN::emailToUtf8($this->sEmail) : $this->sEmail;
	}
