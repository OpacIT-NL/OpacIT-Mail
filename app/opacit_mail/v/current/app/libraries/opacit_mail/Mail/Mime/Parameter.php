...
class Parameter implements \JsonSerializable
{
	...
	public function ToString(bool $bConvertSpecialsName = false) : string
	{
		...
		if ($bConvertSpecialsName && \in_array(\strtolower($this->sName), array(
			\strtolower(Enumerations\Parameter::NAME->value),
			\strtolower(Enumerations\Parameter::FILENAME->value)
		)))
		{
			return $this->sName . '="' . \opacit_mail\Mail\Base\Utils::EncodeHeaderValue($this->sValue) . '"';
		}
