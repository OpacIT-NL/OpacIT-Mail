...
abstract class DateTimeHelper
{
	...
	public static function ParseRFC2822DateString(string $sDateTime) : int
	{
		...
		if (empty($sDateTime)) {
			\opacit_mail\Engine\Log::info('', "No RFC 2822 date to parse");
			return 0;
		}

		// Strip invalid data after zone,
		...
		if (!$oDateTime || 398045302 > $oDateTime->getTimestamp()) {
			\opacit_mail\Engine\Log::notice('', "Failed to parse RFC 2822 date '{$sDateTime}'");
		}
