...
namespace opacit_mail\Mail\Cache\Drivers;
 ...
 * @subpackage Drivers
 */
class File implements \opacit_mail\Mail\Cache\DriverInterface
{
	...
	function __construct(string $sCacheFolder)
	{
		...
		\opacit_mail\Mail\Base\Utils::mkdir($this->sCacheFolder);
	...
	{
		\opacit_mail\Mail\Base\Utils::RecTimeDirRemove($this->sCacheFolder, 3600 * $iTimeToClearInHours);
		return true;
	}
