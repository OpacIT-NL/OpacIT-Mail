...
trait Status
{
	...
	public function generateETag(\opacit_mail\Mail\Imap\ImapClient $oImapClient) : void
	{
		if (!$this->hasStatus) {
	 ...
	 *        ResponseList[1] => STATUS
	 */
	public function setStatusFromResponse(\opacit_mail\Mail\Imap\Response $oResponse) : bool
	{
		$bResult = false;
