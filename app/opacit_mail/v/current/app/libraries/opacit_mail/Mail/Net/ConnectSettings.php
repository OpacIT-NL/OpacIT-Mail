...
//	public bool $tls_weak = false;
	...
	{
		$value = \opacit_mail\Engine\IDN::emailToAscii($value);
//		$value = \opacit_mail\Engine\IDN::emailToAscii(\opacit_mail\Mail\Base\Utils::Trim($value));
		if ($this->shortLogin && $allowShorten) {
			$value = \opacit_mail\Mail\Base\Utils::getEmailAddressLocalPart($value);
		}
	...
	public static function fromArray(array $aSettings) : self
	{
		...
		$object->type = $aSettings['type'] ?? $aSettings['secure'] ?? \opacit_mail\Mail\Net\Enumerations\ConnectionSecurityType::AUTO_DETECT->value;
