...
namespace opacit_mail\Mail\Imap\Responses;
...
class ACL implements \JsonSerializable
{
	...
	public function hasRight(string|\opacit_mail\Mail\Imap\Enumerations\FolderACL $right) : bool
	{
		if ($right instanceof \opacit_mail\Mail\Imap\Enumerations\FolderACL) {
			return \str_contains($this->rights, $right->value);
		}
		$enum = \opacit_mail\Mail\Imap\Enumerations\FolderACL::tryFrom($right);
