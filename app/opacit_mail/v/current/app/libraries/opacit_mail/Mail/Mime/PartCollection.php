 ...
 * @package Mime
 */
class PartCollection extends \opacit_mail\Mail\Base\Collection
{
	...
	public function Boundary() : string
	{
		if (!$this->sBoundary) {
			$this->sBoundary =
				\opacit_mail\Mail\Config::$BoundaryPrefix
				. \opacit_mail\Engine\UUID::generate()
				. '-' . ++self::$increment;
	...
	public function ToStream()
	{
		if ($this->count() && $this->sBoundary) {
			...
			$aResult[] = "\r\n--{$this->sBoundary}--\r\n";
			return \opacit_mail\Mail\Base\StreamWrappers\SubStreams::CreateStream($aResult);
		}
		return null;
	}
}
