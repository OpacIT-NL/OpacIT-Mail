...
abstract class Parser
{
	...
	{
		if (null === $oPart->Body) {
			$oPart->Body = \opacit_mail\Mail\Base\ResourceRegistry::CreateMemoryResource();
		}
	...
	public static function parseStream($rStreamHandle) : ?Part
	{
		...
		$sFirstNotNullCharset = (null !== $sFirstNotNullCharset)
			? $sFirstNotNullCharset : \opacit_mail\Mail\Base\Enumerations\Charset::ISO_8859_1->value;
