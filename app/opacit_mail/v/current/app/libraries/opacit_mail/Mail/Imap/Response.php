...
class Response
{
	...
	public function setStatus(string $value) : void
	{
		...
		$this->IsStatusResponse = \opacit_mail\Mail\Imap\Enumerations\ResponseStatus::tryFrom($value) !== null;
	}
	...
	public function setTag(string $value) : void
	{
		$this->Tag = $value;
		if ('+' === $value) {
			$this->ResponseType = ResponseType::CONTINUATION->value;
		} else if ('*' === $value) {
			$this->ResponseType = ResponseType::UNTAGGED->value;
		} else {
			$this->ResponseType = ResponseType::UNKNOWN->value;
		}
	}
