 ...
 * @package Imap
 */
class ResponseCollection extends \opacit_mail\Mail\Base\Collection
{
	...
	public function validate() : self
	{
		...
		if ($oItem->ResponseType !== Enumerations\ResponseType::CONTINUATION->value) {
			if (!$oItem->IsStatusResponse) {
				throw new Exceptions\InvalidResponseException($this);
			}

			if (Enumerations\ResponseStatus::OK->value !== $oItem->StatusOrIndex) {
