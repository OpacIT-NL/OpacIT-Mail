...
use opacit_mail\Engine\SMime\OpenSSL;
use opacit_mail\Engine\SMime\Certificate;
...
trait SMime
{
	...
	public function DoSMimeExportPrivateKey() : array
	{
		...
		$SMIME->setPrivateKey(
			...
			new \opacit_mail\Engine\SensitiveString($this->GetActionParam('oldPassphrase', ''))
		);
		$result = $SMIME->exportPrivateKey(
			new \opacit_mail\Engine\SensitiveString($this->GetActionParam('newPassphrase', ''))
		);
