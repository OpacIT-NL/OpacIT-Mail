...
class SensitiveString /* extends SensitiveParameterValue | SensitiveParameter */ implements \Stringable, \JsonSerializable
{
	...
	{
		\strlen($value) && \opacit_mail\Engine\Api::Actions()->logMask($value);
		if (\is_callable('sodium_crypto_secretbox')) {
	...
	{
		throw new \Exception("JSON serialization of 'opacit_mail\\Engine\\SensitiveString' is not allowed");
	}
	...
	{
		throw new \Exception("Serialization of 'opacit_mail\\Engine\\SensitiveString' is not allowed");
	}

	public function __unserialize(array $data): void
	{
		throw new \Exception("Unserialization of 'opacit_mail\\Engine\\SensitiveString' is not allowed");
	}
}
