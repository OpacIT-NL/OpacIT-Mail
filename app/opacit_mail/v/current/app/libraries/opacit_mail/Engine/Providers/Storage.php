...
class Storage extends \opacit_mail\Engine\Providers\AbstractProvider
{
	/**
	 * @var \opacit_mail\Engine\Providers\Storage\IStorage
	 */
	private $oDriver;

	public function __construct(\opacit_mail\Engine\Providers\Storage\IStorage $oDriver)
	{
	...
	{
		return \opacit_mail\Engine\Providers\Storage\Enumerations\StorageType::NOBODY->value === $iStorageType
			|| $mAccount instanceof \opacit_mail\Engine\Model\Account
			|| \is_string($mAccount);
	}
