...
namespace opacit_mail\Engine\Providers\AddressBook;
...
*/
	...
	public static function CsvStreamToContacts(/*resource*/ $rFile, string $sDelimiter) : iterable
	{
		...
		foreach ($aHeaders as $iIndex => $sItemName) {
			$sItemName = \opacit_mail\Mail\Base\Utils::Utf8Clear($sItemName);
			...
			if (!\array_key_exists($sItemName, VCard::$propertyMap)) {
				...
				$sItemName = isset(self::$aMap[$sItemName]) ? self::$aMap[$sItemName] : null;
			}
...
/*
	...
	{
		MECARD:N:demo;ORG:opacit_mail;TEL:+49012345678;URL:https\://opacit_mail.dev;EMAIL:info@opacit_mail.dev;ADR:address line;;
		VCARD
	}
*/
}
