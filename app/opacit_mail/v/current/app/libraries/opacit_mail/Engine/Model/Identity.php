...
class Identity implements \JsonSerializable
{
	...
	public ?SensitiveString $smimeKey = null;
	public string $smimeCertificate = '';
	...
	function toMime() : \opacit_mail\Mail\Mime\Email
	{
		return new \opacit_mail\Mail\Mime\Email($this->sEmail, $this->sName);
	}
	...
	public function FromJSON(array $aData, bool $bJson = false): bool
	{
		if (!empty($aData['Email'])) {
			...
			$this->sEmail = $bJson ? \opacit_mail\Engine\IDN::emailToAscii($aData['Email']) : $aData['Email'];
	...
	public function jsonSerialize()
	{
		return array(
			...
			'id' => $this->sId,
			'label' => $this->sLabel,
			'email' => \opacit_mail\Engine\IDN::emailToUtf8($this->sEmail),
			'name' => $this->sName,
			'replyTo' => $this->sReplyTo,
			'bcc' => $this->sBcc,
			'signature' => $this->sSignature,
