...
//				$aAccountHash['login'] = $oDomain->ImapSettings()->fixUsername($aAccountHash['login']);
				...
				$oAccount = new static;
				$oAccount->sEmail = \opacit_mail\Engine\IDN::emailToAscii($aAccountHash['email']);
//				$oAccount->sImapUser = \opacit_mail\Engine\IDN::emailToAscii($aAccountHash['login']);
			...
			\opacit_mail\Engine\Log::debug('ACCOUNT', $e->getMessage());
	...
	public function ImapConnectAndLogin(\opacit_mail\Engine\Plugins\Manager $oPlugins, \opacit_mail\Mail\Imap\ImapClient $oImapClient, \opacit_mail\Engine\Config\Application $oConfig) : bool
	{
...
//		$oSettings->thread_limit = \min($oSettings->thread_limit, (int) $oConfig->Get('imap', 'large_thread_limit', 50));
	...
	public function SmtpConnectAndLogin(\opacit_mail\Engine\Plugins\Manager $oPlugins, \opacit_mail\Mail\Smtp\SmtpClient $oSmtpClient) : bool
	{
		$oSettings = $this->Domain()->SmtpSettings();
		$oSettings->username = $this->SmtpUser();
		$oSettings->Ehlo = \opacit_mail\Mail\Smtp\SmtpClient::EhloHelper();
...
*/
	...
	public function SieveConnectAndLogin(\opacit_mail\Engine\Plugins\Manager $oPlugins, \opacit_mail\Mail\Sieve\SieveClient $oSieveClient, \opacit_mail\Engine\Config\Application $oConfig)
	{
	...
	private function netClientLogin(\opacit_mail\Mail\Net\NetClient $oClient, \opacit_mail\Engine\Plugins\Manager $oPlugins) : bool
	{
/*
...
/*
	...
	public function settingsLocal() : \opacit_mail\Engine\Settings
	{
		return \opacit_mail\Engine\Api::Actions()->SettingsProvider(true)->Load($this);
	}
*/
